...
def visualize(resultsFile, double_als, output_path):
    ...
    for idx, sol_line in enumerate(SOL_LINES):
        ...
        if sol_line.split(',')[0] != "FAMCODE":  # skip header line
            ...
            if FAM_CODE in double_als and double_als[FAM_CODE] == 'F':
                colors_f[1] = '#FFFFFF'
            elif FAM_CODE in double_als and double_als[FAM_CODE] == 'M':
                colors_m[1] = '#FFFFFF'
            ...
            for child_num in range(childs_num):
                ...
                for hap in range(2):
                    ...
                    if hap == 0:
                        ...
                        currentAxis.annotate('Child '+cur_child.split('=')[0],xy=child_caption,color='black', weight='bold', fontsize=10, ha='center',va='center')
